// Command bbb-m3-test-data is the `bbb-m3-test` observer's DATA STAGE: a second
...
// obs/protos for where the NAME lives so that this module and obs/m3 can both
...
//go:noinline
func onData() { obsdata.ExpressLoader(protos.M3Loader) }
