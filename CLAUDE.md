...
|---|---|---|--:|
| **2.0.77** `base` | `1e1fcf4f56f5ef22...` | `aa75497e55ce4333...` | 3427049257 |
| **2.0.77** `incumbent` | `e7001bf98d6c6771...` | `aa75497e55ce4333...` | 223071962 |
| **2.1.16** `base` | `957bfa81da5125bf...` | `c1c8c44b50b6c724...` | 918808251 |
| **2.1.16** `incumbent` | `4ffb0e3b68f149d8...` | `c1c8c44b50b6c724...` | 2044872442 |
| **2.1.17** `base` | `957bfa81da5125bf...` | `c1c8c44b50b6c724...` | 918808251 |
| **2.1.17** `incumbent` | `4ffb0e3b68f149d8...` | `c1c8c44b50b6c724...` | 2044872442 |
...
**THE 2.1.17 LINE IS 2.1.16'S TO THE DIGIT IN EVERY FIELD**, both mod sets, and it is recorded as its own line rather than aliased because a golden is PER ENGINE by construction -- the equality is a measurement of this release, not a rule about the next one. It is what a release carrying no prototype change looks like from this instrument, and it agrees with `fklua api diff 2.1.16 2.1.17`: 0 breaking, 1 additive, and the one additive change is a `RenderLayer` union arm, which is a runtime concept and reaches no prototype.
