...
| `custom` (since 0.3.3) | whatever `bbb-recipe-ingredients` says, in FkRecipes' ingredient language; the word `default` there is the vanilla plan WITH its ladders. "Round three" below |
...
**Red-proven, round three, each injected in THIS MOD's code or locale (never the library), observed, restored and the restore confirmed by cmp** (scratchpad `redproof.py` and `gate-redproof.sh`, plus the review's ten of its own in `review-c/redproof2.py`; the recipe customizer's own proofs are in 50c0db3's message):
...
|---|---|---|--:|
| **2.0.77** `base` | `1e1fcf4f56f5ef22...` | `e5e7d159e88f4a6b...` | 3427049257 |
| **2.0.77** `incumbent` | `e7001bf98d6c6771...` | `e5e7d159e88f4a6b...` | 223071962 |
