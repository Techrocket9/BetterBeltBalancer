...
guest/go/                the Go guest, its own module (//go:wasmimport is
                         ...
                         half ("A belt that turns as it leaves"),
                         lifecycle.go is
