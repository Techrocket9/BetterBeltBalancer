...
make datastage-check
              ...
              # HASHED against goldens, eight VARIANT arms (one per non-default
...
|---|---|---|--:|
| **2.0.77** `base` | `f4fbcaa603abc93b...` | `196275f867f7f8b5...` | 790230733 |
| **2.0.77** `incumbent` | `e7001bf98d6c6771...` | `196275f867f7f8b5...` | 223071962 |
...
Captured, then RE-RUN against themselves to prove the dump is deterministic, and the whole eleven-arm gate is green on 2.0.77 -- the two hashed arms, all eight variant arms and the speed arm, which builds its Go fixture mod and derives 0.5 from an underground exactly as it does on trunk. **The DECISION never waited for any of this**: `go test ./engine/` proves 2.0.x true, 2.1.x false and false-safe for anything unreadable, which is the same split `edgemode` already makes one stage later.
