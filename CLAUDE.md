...
|---|---|---|--:|
| **2.0.77** `base` | `1e1fcf4f56f5ef22...` | `0bea93fa1594052e...` | 3427049257 |
| **2.0.77** `incumbent` | `e7001bf98d6c6771...` | `0bea93fa1594052e...` | 223071962 |
...
**THE 2.0.77 ROWS MOVED THREE TIMES SINCE THEY WERE CAPTURED, EACH ON PURPOSE AND EACH READ OUT OF THE DUMP BEFORE THE CAPTURE**: base `data_raw` `f4fbcaa603abc93b` to `1e1fcf4f56f5ef22` when the legacy stub item's `place_result` moved to the stub entity (cb89891, the freeze fix; the incumbent arm defines no stub and did not move), and `mod_settings` on both mod sets `196275f867f7f8b5` to `258d44de08b43c9e` (the recipe customizer, 50c0db3) to `0bea93fa1594052e` (the research customizer). The 2.1 rows carry `_stale` notes naming the same three moves for the next 2.1 session.
