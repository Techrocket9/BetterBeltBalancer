...
tools/                   make-graphics.py -- the 47-cell adaptive sprite
                         ...
                         Lua config. Each probes the binary before the engine
                         runs and refuses NOT RUN, naming the remedy, when it
                         lacks the command
