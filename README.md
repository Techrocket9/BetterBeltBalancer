...
Released under the [MIT License](LICENSE), artwork included. FkLua, which
compiles the guest, is MIT licensed as well.

The artwork under `mod-data/graphics/` and `mod-data/thumbnail.png` was created
for this project by [Edjie Arts](https://edjie.carrd.co) and is distributed
under that licence with attribution retained. If you redistribute or modify
this mod, keep the credit.
